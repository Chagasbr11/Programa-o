...
public class Biblioteca {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (contandor < 100) {
            ...
            if (menu == 1) {
                ...
                gerarRelatorio(autor, areaDeInteresse, numeroDePaginas, contandor);
            }
            else if (menu == 0) {
                break;
            }
    ...
    public static void gerarRelatorio(String[] autor, String[] areaDeInteresse, int[] numeroDePaginas, int contador) {
